...
export default function AbrirCajaModal({ show, onClose }) {
        ...
        <Modal show={show} onClose={cerrar} maxWidth="md">
            <form onSubmit={submit} className="p-6">
                ...
                <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    Declara el monto inicial en efectivo con el que arrancas el turno.
                </p>

                <div className="mt-4 space-y-4">
                    <div>
                        <InputLabel htmlFor="monto_apertura" value="Monto de apertura (S/)" />
                        <TextInput
                            id="monto_apertura"
                            inputMode="decimal"
                            pattern="[0-9]*[.]?[0-9]*"
                            ...
                            onChange={(e) =>
                                setData('monto_apertura', soloDecimalPositivo(e.target.value, 8, 2))
                            }
                            placeholder="0.00"
                            isFocused
                        />
                        <InputError message={errors.monto_apertura} className="mt-2" />
                    </div>
