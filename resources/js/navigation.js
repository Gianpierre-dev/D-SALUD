...
export const navigation = [
    ...
    },
    {
        ...
        items: [
            ...
            { label: 'Movimientos', routeName: 'inventario.movimientos.index', permission: 'inventario.read', icon: IconArrowsExchange },
            { label: 'Compras', routeName: 'compras.index', permission: 'compras.read', icon: IconTruckDelivery },
